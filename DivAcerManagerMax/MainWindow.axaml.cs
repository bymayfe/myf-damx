...
public partial class MainWindow : Window, INotifyPropertyChanged
{
    ...
    private RadioButton _smartProfileButton;
    ...
    private void BindControls()
    {
        ...
        _smartProfileButton = nameScope.Find<RadioButton>("SmartProfileButton");
    ...
    private void AttachEventHandlers()
    {
        ...
        if (_smartProfileButton != null) _smartProfileButton.Click += ProfileButton_Click;
    ...
    private void UpdateProfileButtons()
    {
        ...
        var profileConfigs =
            new Dictionary<string, (RadioButton button, string description, bool showOnBattery, bool showOnAC)>
            {
                ...
                {
                    "smart",
                    (_smartProfileButton, "AI Akıllı Fan Modu: Sıcaklığa duyarlı dinamik soğutma (Buz Eğrisi).", false, true)
                },
                {
        ...
        else
        {
            ...
            if (_thermalProfileInfoText != null)
                _thermalProfileInfoText.Text = profile switch
                {
                    ...
                    "smart" => "AI Akıllı Fan Modu: Sıcaklığa duyarlı dinamik soğutma (Buz Eğrisi).",
